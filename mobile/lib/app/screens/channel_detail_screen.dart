            ...
            return RefreshIndicator(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  for (final video in recordings) ...<Widget>[
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 8),
                      child: ClassicVideoCard(
                        ...
                        onOpen: () {
                          Navigator.of(context).push<VideoPlayerResult>(
...
class _ChannelHeroCard extends StatelessWidget {
  const _ChannelHeroCard({
    required this.channel,
    required this.previewUrl,
    required this.recordingsCount,
    required this.recordingsSize,
                ...
                Row(
                  children: <Widget>[
                    _HeaderActionButton(
                      ...
                      tooltip: (channel.isPaused ?? false) ? "Resume" : "Pause",
                      icon: (channel.isPaused ?? false) ? Icons.play_arrow_rounded : Icons.pause_rounded,
                    ),
                    const SizedBox(width: 8),
                    _HeaderActionButton(
                      onPressed: onToggleFavorite,
                      tooltip: "Favorite",
                      icon: (channel.fav ?? false) ? Icons.favorite_rounded : Icons.favorite_border_rounded,
                      foregroundColor: (channel.fav ?? false) ? Colors.pink : null,
                    ),
                    const SizedBox(width: 8),
                    _HeaderActionButton(
                      onPressed: onEdit,
      ...
      child: InkWell(
        ...
        child: Tooltip(
          ...
          child: SizedBox(
            width: 40,
            height: 40,
            child: Icon(icon, size: 20, color: foregroundColor ?? theme.colorScheme.primary),
          ),
        ),
      ),
    );
