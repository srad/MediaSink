...
import (
	httpmiddleware "github.com/srad/mediasink/server/internal/http/middleware"
	v2 "github.com/srad/mediasink/server/internal/http/v2"
	analysissvc "github.com/srad/mediasink/server/internal/service/analysis"
	authsvc "github.com/srad/mediasink/server/internal/service/auth"
	jobsvc "github.com/srad/mediasink/server/internal/service/jobs"
	recordingssvc "github.com/srad/mediasink/server/internal/service/recordings"
	userssvc "github.com/srad/mediasink/server/internal/service/users"
	"github.com/srad/mediasink/server/internal/store/relational"
)
