...
func file_tensorflow_core_framework_variable_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tensorflow_core_framework_variable_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_tensorflow_core_framework_variable_proto_msgTypes[1].Exporter = func(v any, i int) any {
