...
var file_tensorflow_core_framework_full_type_proto_goTypes = []any{
...
func file_tensorflow_core_framework_full_type_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tensorflow_core_framework_full_type_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_tensorflow_core_framework_full_type_proto_msgTypes[0].OneofWrappers = []any{
		(*FullTypeDef_S)(nil),
		(*FullTypeDef_I)(nil),
	}
	type x struct{}
