...
func file_tensorflow_core_protobuf_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tensorflow_core_protobuf_cluster_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*JobDef); i {
			case 0:
				return &v.state
			case 1:
		...
		file_tensorflow_core_protobuf_cluster_proto_msgTypes[1].Exporter = func(v any, i int) any {
