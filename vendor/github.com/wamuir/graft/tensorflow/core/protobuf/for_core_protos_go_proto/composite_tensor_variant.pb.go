...
var file_tensorflow_core_protobuf_composite_tensor_variant_proto_goTypes = []any{
...
func file_tensorflow_core_protobuf_composite_tensor_variant_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tensorflow_core_protobuf_composite_tensor_variant_proto_msgTypes[0].Exporter = func(v any, i int) any {
