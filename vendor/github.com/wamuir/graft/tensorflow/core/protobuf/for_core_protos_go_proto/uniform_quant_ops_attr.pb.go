...
var file_tensorflow_core_util_quantization_uniform_quant_ops_attr_proto_goTypes = []any{
...
func file_tensorflow_core_util_quantization_uniform_quant_ops_attr_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tensorflow_core_util_quantization_uniform_quant_ops_attr_proto_msgTypes[0].Exporter = func(v any, i int) any {
