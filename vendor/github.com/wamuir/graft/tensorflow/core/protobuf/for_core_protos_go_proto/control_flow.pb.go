...
func file_tensorflow_core_protobuf_control_flow_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tensorflow_core_protobuf_control_flow_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_tensorflow_core_protobuf_control_flow_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_tensorflow_core_protobuf_control_flow_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_tensorflow_core_protobuf_control_flow_proto_msgTypes[3].Exporter = func(v any, i int) any {
