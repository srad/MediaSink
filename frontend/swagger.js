...
// Use a local swagger.json file when SWAGGER_INPUT is set (avoids needing a running server).
// Falls back to fetching from a running server.
const swaggerInput = process.env.SWAGGER_INPUT
  ? { input: path.resolve(process.env.SWAGGER_INPUT) }
